...
#import "RZAutoScrollTextField.h"

@interface RZAutoScrollTextField()
{
...
@implementation RZAutoScrollTextField
...
{
    bounds.origin.x += self.textFieldInset.left;
    bounds.origin.y += self.textFieldInset.top;
    bounds.size.width -= self.textFieldInset.right;
    bounds.size.height -= self.textFieldInset.bottom;
    return bounds;
}
...
- (void)setTextFieldInset:(UIEdgeInsets)textFieldInset {
    _textFieldInset = textFieldInset;
